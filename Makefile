...
test:
	...
	fab publish_test:iris
	cd /tmp/databoard_local/databoard_iris_8080; fab test_ramp

	fab publish_test:boston_housing
	cd /tmp/databoard_local/databoard_boston_housing_8080; fab test_ramp

test-all: test
	fab publish_test:mortality_prediction
	fab publish_test:pollenating_insects
	fab publish_test:kaggle_otto
