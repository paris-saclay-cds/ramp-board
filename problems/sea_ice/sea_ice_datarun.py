...
X_train_filename = 'sea_ice_X_train.nc'
y_train_filename = 'sea_ice_y_train.npy'
X_test_filename = 'sea_ice_X_test.nc'
y_test_filename = 'sea_ice_y_test.npy'
...
def get_train_data(raw_data_path):
    X_train_ds = xr.open_dataset(os.path.join(raw_data_path, X_train_filename),
                                 decode_times=False)
