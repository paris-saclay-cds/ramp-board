...
if __name__ == "__main__":
    ...
    setup(name=DISTNAME,
          ...
          packages=[
              ...
              'databoard.ramps.bankruptcy',
              'databoard.ramps.boston_housing',
              'databoard.ramps.el_nino_bagged_cv_future',
              'databoard.ramps.el_nino_block_cv',
              'databoard.ramps.epidemium_cancer_rate',
              'databoard.ramps.iris',
              'databoard.ramps.kaggle_otto',
              'databoard.ramps.macro_abm',
              'databoard.ramps.mortality_prediction',
              'databoard.ramps.pollenating_insects',
              'databoard.ramps.variable_stars',
          ],
          scripts=['fabfile.py'])
