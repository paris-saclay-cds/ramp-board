...
X_train_filename = os.path.join(
    problems_path, problem_name, 'data', 'private', 'el_nino_X_train.nc')
y_train_filename = os.path.join(
    problems_path, problem_name, 'data', 'private', 'el_nino_y_train.npy')
X_test_filename = os.path.join(
    problems_path, problem_name, 'data', 'private', 'el_nino_X_test.nc')
y_test_filename = os.path.join(
    problems_path, problem_name, 'data', 'private', 'el_nino_y_test.npy')
