import databoard.specific.score_types.mare_mixed as mare
import databoard.specific.score_types.error_mixed as error


def score_function(true_predictions, predictions, valid_indexes=None):
    return 2. / 3 * error.score_function(
        true_predictions, predictions, valid_indexes) +\
