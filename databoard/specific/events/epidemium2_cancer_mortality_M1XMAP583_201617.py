...
event_name = 'epidemium2_cancer_mortality_M1XMAP583_201617'  # should be the same as the file name
...
public_opening_timestamp = datetime.datetime(2017, 1, 23, 19, 0, 0)
