...
from databoard.specific.problems.pollenating_insects import problem_name  # noqa

event_name = 'pollenating_insects_M1XMAP583_M2HECXMAP542_201617'  # should be the same as the file name
