...
event_name = 'epidemium2_cancer_mortality_M2HECXMAP542_201617'  # should be the same as the file name

# Unmutable config parameters that we always read from here

event_title = 'Epidemium cancer mortality rate prediction (2nd RAMP), M2 HEC/X MAP542 2016/17'
...
public_opening_timestamp = datetime.datetime(2017, 1, 29, 19, 0, 0)
