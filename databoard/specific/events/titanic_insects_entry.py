...
event_name = 'titanic_insects_entry'  # should be the same as the file name

# Unmutable config parameters that we always read from here

event_title = 'Entry exam to deep learning tutorial'
...
public_opening_timestamp = datetime.datetime(2100, 1, 1, 0, 0, 0)
