import numpy as np
import datetime
from databoard.specific.problems.el_nino import problem_name  # noqa

event_name = 'el_nino_colorado'  # should be the same as the file name
...
public_opening_timestamp = datetime.datetime(2016, 12, 15, 19, 0, 0)
